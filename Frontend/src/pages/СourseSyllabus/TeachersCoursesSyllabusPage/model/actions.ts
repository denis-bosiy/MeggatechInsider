enum TEACHERS_COURSES_SYLLABUS_PAGE_ACTIONS {
  TEACHERS_COURSES_SYLLABUS_PAGE_SET_CATEGORY_PAYROLL_ACCOUNTING = "TEACHERS_COURSES_SYLLABUS_PAGE_SET_CATEGORY_PAYROLL_ACCOUNTING",
  TEACHERS_COURSES_SYLLABUS_PAGE_SET_WORKING_CONTRACT_PAYROLL_ACCOUNTING = "TEACHERS_COURSES_SYLLABUS_PAGE_SET_WORKING_CONTRACT_PAYROLL_ACCOUNTING",
  TEACHERS_COURSES_SYLLABUS_PAGE_SET_IS_CLASSROOM_TEACHER = "TEACHERS_COURSES_SYLLABUS_PAGE_SET_IS_CLASSROOM_TEACHER",
  TEACHERS_COURSES_SYLLABUS_PAGE_SET_IN_DEPTH_SUBJECT_PAYROLL_ACCOUNTING = "TEACHERS_COURSES_SYLLABUS_PAGE_SET_IN_DEPTH_SUBJECT_PAYROLL_ACCOUNTING",
  TEACHERS_COURSES_SYLLABUS_PAGE_SET_FINAL_EXAM_PAYROLL_ACCOUNTING = "TEACHERS_COURSES_SYLLABUS_PAGE_SET_FINAL_EXAM_PAYROLL_ACCOUNTING",
...
type ActionSetCategoryPayrollAccounting = {
  type: TEACHERS_COURSES_SYLLABUS_PAGE_ACTIONS.TEACHERS_COURSES_SYLLABUS_PAGE_SET_CATEGORY_PAYROLL_ACCOUNTING,
  payload: {teacherId: number, categoryPayrollAccounting: boolean},
}

type ActionSetWorkingContractPayrollAccounting = {
  type: TEACHERS_COURSES_SYLLABUS_PAGE_ACTIONS.TEACHERS_COURSES_SYLLABUS_PAGE_SET_WORKING_CONTRACT_PAYROLL_ACCOUNTING,
  payload: {teacherId: number, workingContractPayrollAccounting: boolean},
}

type ActionSetIsClassroomTeacher = {
  type: TEACHERS_COURSES_SYLLABUS_PAGE_ACTIONS.TEACHERS_COURSES_SYLLABUS_PAGE_SET_IS_CLASSROOM_TEACHER,
  payload: {teacherId: number, isClassroomTeacher: boolean},
}

type ActionSetInDepthSubjectPayrollAccounting = {
  type: TEACHERS_COURSES_SYLLABUS_PAGE_ACTIONS.TEACHERS_COURSES_SYLLABUS_PAGE_SET_IN_DEPTH_SUBJECT_PAYROLL_ACCOUNTING,
  payload: {teacherId: number, inDepthSubjectPayrollAccounting: boolean},
}

type ActionSetFinalExamPayrollAccounting = {
  type: TEACHERS_COURSES_SYLLABUS_PAGE_ACTIONS.TEACHERS_COURSES_SYLLABUS_PAGE_SET_FINAL_EXAM_PAYROLL_ACCOUNTING,
