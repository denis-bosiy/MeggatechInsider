import {TarifficationReportData} from "./model/types";
...
function useTableData(data: TarifficationReportData) {
  const [searchQuery, setSearchQuery] = useState("");
  const [tableData, setTableData] = useState<TarifficationReportData>(
