...
const DiscrepanciesCoursesSyllabus = () => {
  const data = useSelector(
    (state: { assigningCoursesSyllabusPageStore: AssigningCoursesSyllabusPageData }) =>
      state.assigningCoursesSyllabusPageStore
  );
...
const AssigningCoursesSyllabusPage = () => {
  ...
  const [assigningsTableData, setAssigningsTableData] = useState<AssigningsCoursesSyllabusData>(
    structuredClone(assignings)
  );
          ...
          <table className="table -fill -list">
            <thead className="header">
              <tr className="row">
                ...
                <th className="cell -filter" onClick={() => handleSort("hoursOnWeek")}>
                  Часов в неделю
                </th>
                <th className="cell -filter" onClick={() => handleSort("hoursOnYear")}>
                  Часов всего
                </th>
                <th className="cell -filter" onClick={() => handleSort("costPerHour")}>
                  Стоимость часа
                </th>
              </tr>
            </thead>
            <tbody>
              {assigningsTableData
                .filter(
                  (data: AssigningCoursesSyllabusData, index: number) =>
