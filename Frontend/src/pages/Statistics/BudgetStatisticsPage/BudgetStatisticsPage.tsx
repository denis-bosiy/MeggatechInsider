...
const BudgetStatisticsPage = () => {
  const { class10, class11, total } = useSelector(
    (state: { budgetStatisticsPageStore: BudgetStatisticsPageData }) => state.budgetStatisticsPageStore
  );
  ...
  const handleClass10Search = (): void => {
    class10TableManager.invokeFunction("search", TableType.Searchable, [class10SearchQuery, class10]);
  };
  ...
  const handleClass11Search = (): void => {
    class11TableManager.invokeFunction("search", TableType.Searchable, [class11SearchQuery, class11]);
  };
  ...
  const handleTotalSearch = (): void => {
    totalTableManager.invokeFunction("search", TableType.Searchable, [totalSearchQuery, total]);
  };
          ...
          <table className="table -fill -list">
            <thead className="header">
              <tr className="row">
                ...
                <th className="cell -filter" onClick={() => handleSort10("hours")}>
                  Часы
                </th>
                <th className="cell -filter" onClick={() => handleSort10("rates")}>
                  Ставки
                </th>
              </tr>
            </thead>
            <tbody>
              {class10Data
                .filter((data: BudgetStatisticsTableData, index: number) => index !== class10Data.length)
                .map((row: BudgetStatisticsTableData) => {
                  sum10H += row.hours;
                  sum10R += row.rates;
                  return (
        ...
        <div className="budget-statistic-page__box">
          ...
          <table className="table -fill -list">
            <thead className="header">
              <tr className="row">
                <th className="cell">Бюджет</th>
                <th className="cell -filter" onClick={() => handleSort11("hours")}>
                  Часы
                </th>
                <th className="cell -filter" onClick={() => handleSort11("rates")}>
                  Ставки
                </th>
              </tr>
            </thead>
            <tbody>
              {class11Data
                .filter((data: BudgetStatisticsTableData, index: number) => index !== class11Data.length)
                .map((row: BudgetStatisticsTableData) => {
                  sum11H += row.hours;
                  sum11R += row.rates;
                  return (
        ...
        <div className="budget-statistic-page__box">
          ...
          <table className="table -fill -list">
            <thead className="header">
              <tr className="row">
                <th className="cell">Бюджет</th>
                <th className="cell -filter" onClick={() => handleSortTotal("hours")}>
                  Часы
                </th>
                <th className="cell -filter" onClick={() => handleSortTotal("rates")}>
                  Ставки
                </th>
              </tr>
            </thead>
            <tbody>
              {totalData
                .filter((data: BudgetStatisticsTableData, index: number) => index !== totalData.length)
                .map((row: BudgetStatisticsTableData) => {
                  sumTotalH += row.hours;
                  sumTotalR += row.rates;
                  return (
